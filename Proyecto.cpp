...
#include <iostream>
#include <stdlib.h>
#include <time.h> // como voy a crear numeros aleatorios necesito la funcion tiempo
using namespace std;
...
void loop (char c[3][3]){
	...
	{
		cout<<"Puedes intentarlo de nuevo"<<endl;
	}
